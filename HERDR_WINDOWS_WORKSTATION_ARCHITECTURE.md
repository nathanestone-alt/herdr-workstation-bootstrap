...
~~~
Laptop / Surface while local or traveling
|-- Tailscale + SSH --> Ubuntu WSL2 --> Herdr and persistent CLI sessions
|-- Tailscale + RDP --> Windows 11 Pro --> native Excel and COM automation
...
Ubuntu runs under WSL2. Herdr, Git repositories and x86-64 CLI tooling run inside Ubuntu. Routine remote work enters through SSH and reconnects to persistent Herdr sessions.
...
- Tailscale plus SSH for WSL2/Herdr
...
- [ ] Install Ubuntu WSL2 and migrate AMD64 tooling.
- [ ] Install and test Herdr persistence.
- [ ] Configure Tailscale, SSH and RDP.
