...
$allowlist = @(
    # The official Herdr skill is reinstalled from the new Herdr binary.
    # Export only locally maintained coordination/dispatch and personal skills.
...
Write-Host 'Export complete. Review every file before overriding .gitignore. No SSH key, private key, or authentication file is allowlisted.'
